...
os.system(
	f"java -jar compiler.jar --js ../build/{me_filename}.js --js_output_file ../build/{me_filename}.min.js"
)

os.system(
	f"java -jar compiler.jar --js ../build/{mep_filename}.js --js_output_file ../build/{mep_filename}.min.js"
)
